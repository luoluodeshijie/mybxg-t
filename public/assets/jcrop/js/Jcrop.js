...
(function($) {
    ...
    $.extend(BackoffFilter.prototype, {
        ...
        filter: function(b) {
            ...
            if (b.x < r.minx) { b.x = r.minx;
                b.x2 = b.w + b.x; }
            if (b.y < r.miny) { b.y = r.miny;
                b.y2 = b.h + b.y; }
            if (b.x2 > r.maxx) { b.x2 = r.maxx;
                b.x = b.x2 - b.w; }
            if (b.y2 > r.maxy) { b.y2 = r.maxy;
                b.y = b.y2 - b.h; }
    ...
    $.extend(Jcrop.prototype, {
        ...
        nudge: function(x, y) {
            ...
            if (b.x < 0) { b.x2 = b.w;
                b.x = 0; } else if (b.x2 > this.elw) { b.x2 = this.elw;
                b.x = b.x2 - b.w; }

            if (b.y < 0) { b.y2 = b.h;
                b.y = 0; } else if (b.y2 > this.elh) { b.y2 = this.elh;
                b.y = b.y2 - b.h; }
